...
export const metadata = {
  title: "Wedding Hall in Kandrika Vijayawada | SLS Banquets - Perfect Wedding Venue",
  description: "Find the perfect wedding hall in Kandrika, Vijayawada at SLS Banquets. Located in the heart of Kandrika, we offer elegant wedding venues with modern amenities, professional stage setup, and beautiful decorations for your special day.",
  keywords: "wedding hall in Kandrika Vijayawada, marriage hall Kandrika, wedding venue Kandrika, reception hall Kandrika, wedding reception venue Kandrika, marriage ceremony hall Kandrika, wedding function hall Kandrika, bridal venue Kandrika, wedding celebration hall Kandrika, matrimonial hall Kandrika"
};

export default function WeddingHallKandrikaPage() {
  return (
    <>
      <SEO />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-pink-100">
              SLS Banquets - Your Dream Wedding Destination in the Heart of Kandrika
            </p>
          </div>
        </div>
      </div>
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="mb-12">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              Located in the heart of Kandrika, SLS Banquets offers the perfect <strong>wedding hall in Kandrika Vijayawada</strong> for your special day. Our elegant venue combines traditional charm with modern amenities, creating the ideal setting for your wedding celebration. With easy accessibility and beautiful surroundings, we make your dream wedding come true.
            </p>
          </div>

          {/* Why Choose SLS in Kandrika */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose SLS Banquets in Kandrika?</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="bg-pink-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-pink-900 mb-3 flex items-center gap-2">
                  <FaMapMarkerAlt className="text-pink-600" />
                  Prime Kandrika Location
                </h3>
                <p className="text-gray-700">
                  Situated in the heart of Kandrika, our wedding hall is easily accessible from all major areas of Vijayawada. The convenient location makes it perfect for guests traveling from different parts of the city and surrounding areas.
                </p>
              </div>
          ...
          {/* Wedding Services */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Complete Wedding Services in Kandrika</h2>
          ...
          {/* Location Benefits */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Kandrika Location Benefits</h2>
            
            <div className="bg-blue-50 p-8 rounded-lg">
              <p className="text-gray-700 mb-6">
                Our location in Kandrika offers several advantages for your wedding:
              </p>
          ...
          {/* Testimonials */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Happy Couples from Kandrika</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700 mb-4">
                  &ldquo;SLS Banquets in Kandrika made our wedding day absolutely perfect! The location was convenient for all our guests, and the facilities were outstanding. Our wedding was everything we dreamed of and more.&rdquo;
                </p>
                <div className="font-semibold text-gray-900">- Priya & Rajesh</div>
                <div className="text-sm text-gray-500">Wedding in Kandrika</div>
              </div>
              ...
              <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700 mb-4">
                  &ldquo;We chose SLS Banquets for our wedding because of its perfect location in Kandrika. The staff was professional, the facilities were excellent, and our guests loved the convenient parking and beautiful venue.&rdquo;
                </p>
          ...
          <section className="bg-gradient-to-r from-pink-900 to-red-900 text-white p-8 rounded-lg text-center">
            <h2 className="text-3xl font-bold mb-4">Book Your Dream Wedding in Kandrika Today!</h2>
            <p className="text-xl text-pink-100 mb-6">
              Don&apos;t wait! Secure your perfect wedding date at SLS Banquets, the most sought-after 
              wedding hall in Kandrika, Vijayawada. Let us help you create the wedding of your dreams.
            </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="flex justify-between items-center">
          ...
          >
            ...
            Previous: Affordable Function Hall
          </Link>
